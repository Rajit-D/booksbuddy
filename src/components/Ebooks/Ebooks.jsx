    ...
    <div>
            ...
            >
              ...
              <div className="offcanvas-body">
                <ul className="navbar-nav justify-content-end flex-grow-1 pe-3">
                  ...
                  <li className="nav-item">
                    <a className="nav-link" href="/pages/community.html">
                      Community
                    </a>
                  </li>
      ...
      <main>
        <div className="books">
          <div>
            <img
              src="img2 home/C programing.jpeg"
              alt=""
              className="book-img"
            />
          </div>
          <div className="descp">
            ...
            <h3 className="author">
              by Jogamohan medak And Prath Pratim Gogoi
            </h3>
            <h3 className="rating">1.987 rating</h3>
            <p className="info">
              The C Programming Language The book enumerates the concepts
              related to C Programming language, as prescribed by ANSI standard.
              The book elaborates on the basics of procedure oriented
              programming and the fundamentals of writing C codes.
            </p>
        ...
        <div className="books">
          ...
          <div className="descp">
            ...
            <p className="info">
              ...
              general-purpose programming languages. At an advanced pace this
              book teaches how to work with compilers updated for the new
              standard.
            </p>
        ...
        <div className="books">
          <div>
            <img
              src="img2 home/Java programing.jpg"
              alt=""
              className="book-img"
            />
          </div>
          <div className="descp">
            ...
            <h3 className="rating">1.987 rating</h3>
            <p className="info">
              The sixth edition of this most trusted book on JAVA for beginners
              is here with some essential updates. Retaining its quintessential
              style of concept explanation with exhaustive programs, solved
              examples, and illustrations, this test takes the journey of
              understanding JAVA to slightly higher level.
            </p>
        ...
        <div className="books">
          ...
          <div className="descp">
            ...
            <p className="info">
              ...
              this subject. It is a book with a difference form other textbooks
              as it lays more emphasis on the conceptual concepts that are
              supported by illustrative examples, plenty of challenging theory
              and programming exercises, to test your knowledge acquired on the
              subject.
            </p>
        ...
        <div className="books">
          ...
          <div className="descp">
            ...
            <p className="info">
              ...
              application development by combining theoretical learning with
              code exercises and fun projects that you can challenge yourself
              with.
            </p>
            <button type="submit">Download</button>
          </div>
        ...
        <div className="books">
          ...
          <div className="descp">
            ...
            <p className="info">
              ...
              interfaces. You use small manageable components to build
              large-sale, data-driven websites without page reloads.
            </p>
            <button type="submit">Download</button>
          </div>
        </div>
