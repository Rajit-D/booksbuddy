    ...
    <main>
      <div className="books">
        ...
        <div className="descp">
          ...
          <h3 className="author">by Tim Bailey</h3>
          ...
          <button type="submit">
            <a
              href="https://drive.google.com/file/d/1AGJX7-95M-qcVdOpKEM9rrs8YVGLrSRi/view?usp=drive_link"
              className="d-btn"
              >Download</a
            >
          </button>
      ...
      <div className="books">
        <div>
          <img src="/images/" alt="" className="book-img" />
        </div>
        <div className="descp">
          <h2 className="book-name">C++ Programing</h2>
          <h3 className="author">by Richard Grimes</h3>
          <h3 className="rating">1.987 rating</h3>
          <p className="info">
          ...
          <button type="submit" id="b1">
            <a
              href="https://drive.google.com/file/d/1SzOhMRKqP0HnHnyY3Pilv9T4C7ByegGC/view?usp=drive_link"
              className="d-btn"
              >Download</a
            >
          </button>
      ...
      <div className="books">
        ...
        <div className="descp">
          ...
          <h3 className="author">by David J. Eck</h3>
          <h3 className="rating">1.987 rating</h3>
          <p className="info">
          ...
          <button type="submit" id="b2">
            <a
              href="https://drive.google.com/file/d/1_Ocg3BM4nrSFwYlPLUO1wmyN80e7z9M0/view?usp=drive_link"
              className="d-btn"
              >Download</a
            >
          </button>
      ...
      <div className="books">
        ...
        <div className="descp">
          ...
          <h3 className="author">by Mark Lutz</h3>
          <h3 className="rating">1.987 rating</h3>
          <p className="info">
          ...
          <button type="submit" id="b3">
            <a
              href="https://drive.google.com/file/d/1qnY9JW2tCPhiu5B_FlG1lih8MFB7dlDD/view?usp=drive_link"
              className="d-btn"
              >Download</a
            >
          </button>
      ...
      <div className="books">
        ...
        <div className="descp">
          ...
          <h3 className="author">by Dr. Jojo Moyes</h3>
          <h3 className="rating">1.987 rating</h3>
          <p className="info">
          ...
          <button type="submit">
            <a
              href="https://drive.google.com/file/d/1Ejiq30mYNWnmsgTd3o1uhH8d9jbImClO/view?usp=drive_link"
              className="d-btn"
              >Download</a
            >
          </button>
      ...
      <div className="books">
        ...
        <div className="descp">
          ...
          <h3 className="author">by Dr. Poornima G. Naik & Dr. Kavita S. Oza</h3>
          <h3 className="rating">1.987 rating</h3>
          <p className="info">
          ...
          <button type="submit">
            <a
              className="d-btn"
              href="https://drive.google.com/file/d/1_CGYOiU9N1nmHu8Lz8BVfPKgQVv-uWJv/view?usp=drive_link"
              >Download</a
            >
          </button>
        </div>
